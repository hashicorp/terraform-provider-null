...
# instance is used to gather data about all three and execute a single
# action that affects them all. Due to the triggers map, the null_resource
# will be replaced each time the instance ids change, and thus the remote-
# exec provisioner will be re-run.
